...
exp.alternative2 <- function(parameters, buses.data, transit.risks, 
  ...
  injury.change <- injury.change[1:4, ]
  
  # computes mean of 4 remaining interviews
  fatality.change.mean <- colMeans(fatality.change)
  injury.change.mean <- colMeans(injury.change)
